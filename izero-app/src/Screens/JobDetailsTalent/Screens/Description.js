...
export default function Description({route}) {
  ...
  const [jobDate, setJobDate] = useState(jobDetails?.job?.expiry_date);
  ...
  const [shiftRoleDescription, setShiftRoleDescription] = useState(
    jobDetails?.title,
  );
  ...
  const [jobUserId, setJobUserId] = useState(jobDetails?.job?.user?.id);

  const [shiftName, setShiftName] = useState(jobDetails?.job_role?.title);
  ...
  //     setJobDate(res?.data?.data?.job?.expiry_date);
  ...
  //     setShiftLat(parseFloat(res?.data?.data?.latitude));
  //     setShiftLong(parseFloat(res?.data?.data?.longitude));
  ...
  //     setJobUserId(res?.data?.data?.job?.user?.id);
  //   } catch (error) {
  //     setLoading(true);
  //     console.log({error});
  //   }
  ...
  //       headers: {Authorization: `Bearer ${jwt}`, Accept: 'application/json'},
  //     });
  //     console.log('Shift for Staff side job details', res);
            ...
            <View
              ...
              <View
                ...
                <View
                  ...
                  <Text style={{textAlign: 'justify', color: colors.darkBlue}}>
                    {aboutJob}
                  </Text>
                </View>
              </View>
              ...
              {statusJob === 'search' ? null : (
                <TouchableHighlight
                  underlayColor=""
                  onPress={() =>
                    navigation.navigate('UploadExpensesTalent', {
                      shiftID: shiftID,
                      userID: jobUserId,
                      shiftName: shiftName,
                    })
                  ...
                  <TouchableOpacity onPress={() => setVissibleRatingView(true)}>
                    <View
                      ...
                      <Rating
                        ...
                        ratingBackgroundColor={colors.lightGreyLow}
                        imageSize={17}
                        defaultRating={5}
                        readonly={true}
                      />
          ...
          <View
            ...
            <View
              ...
              <View
                ...
                <TouchableOpacity onPress={() => setVissibleRatingView(false)}>
                  <View
                    style={{
                      width: widthConverter(261),
                      height: heightConverter(50),
...
const styles = StyleSheet.create({
  ...
  sticky: {
    ...
    //width: widthConverter(305),
    paddingHorizontal: widthConverter(30),
    //backgroundColor: colors.red,
    alignSelf: 'center',
    flexDirection: 'row',
    alignItems: 'center',
