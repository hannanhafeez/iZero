...
export default function Available({navigation}) {
  ...
  const calendarListAvailbility = useSelector(
    (state) => state?.app?.calendarListAvailbility,
  );
  ...
  const [markedDatesArrayNext, setMarkedDatesArrayNext] = useState({});
      ...
      {loading == false ? (
        ...
        <>
          <CalendarComponent
            ...
            markedDates={markedDatesArrayNext}
            // markedDates={{
            //   '2021-08-29': {marked: true, dotColor: '#50cebb'},
            //   '2021-08-30': {marked: true, dotColor: '#50cebb'},
            //   '2021-08-31': {
            //     marked: true,
            //     dotColor: '#50cebb',
            //   },
