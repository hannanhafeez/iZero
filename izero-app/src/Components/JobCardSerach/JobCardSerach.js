        ...
        <View>
          ...
          <View>
            <FlatList
              ...
              // ListFooterComponent={
              //   <View>
              //     <Text style={{marginTop: 12}}>Company logo not found</Text>
              //   </View>
              // }
              renderItem={(item) => (
          ...
          {checkIn ? (
            <TouchableHighlight
              underlayColor=""
              onPress={() => navigation.navigate('QRCodeScan', {jobID: jobID})}>
              <View
                style={{
                  width: 100,
                }}>
